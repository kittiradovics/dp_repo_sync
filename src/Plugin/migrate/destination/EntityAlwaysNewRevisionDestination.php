...
namespace Drupal\dp_repo_sync\Plugin\migrate\destination;
 ...
 *   deriver = "Drupal\dp_repo_sync\Plugin\Derivative\MigrateEntityAlwaysNewRevision",
 * )
 */
class EntityAlwaysNewRevisionDestination extends EntityContentBase {
  ...
  protected function getEntity(Row $row, array $old_destination_id_values) {
    ...
    /** @var \Drupal\dp_repo_sync\Plugin\migrate\source\RepositorySource $sourcePlugin */
