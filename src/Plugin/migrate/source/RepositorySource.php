...
namespace Drupal\dp_repo_sync\Plugin\migrate\source;
...
use Drupal\dp_repo_sync\RepositoryIterator;
...
abstract class RepositorySource extends SourcePluginBase implements MigrateSourceInterface, ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition, MigrationInterface $migration = NULL) {
    ...
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $loggerFactory->get('dp_repo_sync'),
      $cacheBackend,
      $config_factory->get('dp_repo_sync.import')->get('cache'),
      $migration
    );
  }
