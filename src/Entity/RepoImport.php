...
namespace Drupal\dp_repo_sync\Entity;
...
use Drupal\dp_repo_sync\Plugin\migrate\destination\EntityAlwaysNewRevisionDestination;
use Drupal\dp_repo_sync\Plugin\migrate\source\RepositorySource;
 ...
 *   handlers = {
 *     "view_builder" = "Drupal\dp_repo_sync\Controller\RepoImportViewBuilder",
 *     "list_builder" = "Drupal\dp_repo_sync\Controller\RepoImportListBuilder",
 *     "form" = {
 *       "add" = "Drupal\dp_repo_sync\Form\RepoImportForm",
 *       "edit" = "Drupal\dp_repo_sync\Form\RepoImportForm",
 *       "delete" = "Drupal\dp_repo_sync\Form\RepoImportDeleteForm",
 *     },
 *    "access" = "Drupal\dp_repo_sync\RepoImportAccessControlHandler",
 *   },
...
class RepoImport extends ConfigEntityBase implements ConfigEntityInterface, MigrationGeneratorInterface {
  ...
  const MIGRATION_GROUP = 'dp_repo_sync';
    ...
    foreach ($migrations as $entity_type => $migration) {
      ...
      foreach ([$maptable, $messagetable] as $table) {
        try {
          ...
          watchdog_exception('dp_repo_sync', $ex);
        }
      }
    }
  }
